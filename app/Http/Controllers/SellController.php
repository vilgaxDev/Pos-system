...
class SellController extends Controller
{
    ...
    public function show($id)
    {
        ...
        if(!empty($sell->tax)){
            if ($sell->tax->is_tax_group) {
                $order_taxes = $this->transactionUtil->groupTaxDetails($sell->tax, $sell->tax_amount);
            } else {
    ...
    public function edit($id)
    {
        ...
        return view('sell.edit')
            ->with(compact('business_details', 'taxes', 'sell_details', 'transaction', 'commission_agent', 'types', 'customer_groups', 'price_groups'));
    }
