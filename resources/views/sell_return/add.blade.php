				        ...
				        <tbody>
				            ...
				            <tr>
				              	...
				              	<td>
						            ...
						            >
						            <input name="products[{{$loop->index}}][unit_price_inc_tax]" type="hidden" class="unit_price" value="{{@number_format($sell_line->unit_price_inc_tax)}}">
			...
			<div class="row">
				...
				<div class="col-sm-4">
					<div class="form-group">
						...
						{!! Form::text('discount_amount', @number_format($discount_amount), ['class' => 'form-control input_number']); !!}
					</div>
				</div>
			</div>
			@php
