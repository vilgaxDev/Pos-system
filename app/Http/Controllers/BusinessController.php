    ...
    */
    ...
    public function postRegister(Request $request)
    {
        ...
        try {
            ...
            $is_installed_superadmin = $this->moduleUtil->isInstalledSuperadmin();
    ...
    public function getBusinessSettings()
    {
        ...
        return view('business.settings', compact('business', 'currencies', 'tax_rates', 'timezone_list', 'months', 'accounting_methods', 'commission_agent_dropdown', 'units_dropdown', 'date_formats', 'shortcuts', 'pos_settings', 'modules', 'theme_colors', 'email_settings', 'sms_settings'));
    }
