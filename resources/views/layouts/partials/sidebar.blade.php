    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        @if(auth()->user()->can('product.view') || auth()->user()->can('product.create') )
          <li class="treeview {{ in_array($request->segment(1), ['variation-templates', 'products', 'labels', 'import-products', 'import-opening-stock', 'selling-price-group']) ? 'active active-sub' : '' }}" id="tour_step5">
        ...
        'units', 'categories', 'barcodes', 'invoice-schemes', 'business-location', 'invoice-layouts', 'printers', 'payment-account', 'subscription']) || in_array($request->segment(2), ['tables', 'modifiers']) ) {{'active active-sub'}} @endif">
