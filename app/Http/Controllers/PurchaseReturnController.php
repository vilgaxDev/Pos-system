    ...
    public function index()
    {
        ...
        if (request()->ajax()) {
            ...
            return Datatables::of($purchases_returns)
                ...
                ->rawColumns(['final_total', 'action', 'payment_status', 'parent_purchase'])
                ->make(true);
        }
    ...
    public function store(Request $request)
    {
        ...
        try {
	        ...
	        if(!empty($return_transaction)){
	        	...
	        	Transaction::create($return_transaction_data);
	        }
    ...
    public function show($id)
    {
        ...
        if(!empty($purchase->return_parent->tax)){
            if ($purchase->return_parent->tax->is_tax_group) {
                $purchase_taxes = $this->transactionUtil->groupTaxDetails($purchase->return_parent->tax, $purchase->return_parent->tax_amount);
            } else {
