      ...
      <div class="row">
        ...
        <div class="col-sm-4 @if(!empty($duplicate_product) && $duplicate_product->enable_stock == 0) hide @endif" id="alert_quantity_div">
          <div class="form-group">
            ...
            {!! Form::number('alert_quantity', !empty($duplicate_product->alert_quantity) ? @number_format($duplicate_product->alert_quantity) : null , ['class' => 'form-control', 'required',
          ...
          <div class="col-sm-4 @if($hide) hide @endif">
            <div class="form-group">
              <div class="multi-input">
                ...
                {!! Form::text('expiry_period', !empty($duplicate_product->expiry_period) ? @number_format($duplicate_product->expiry_period) : $expiry_period, ['class' => 'form-control pull-left input_number',
